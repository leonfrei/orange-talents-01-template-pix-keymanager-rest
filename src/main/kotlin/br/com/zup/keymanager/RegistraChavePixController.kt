...
class RegistraChavePixController(private val registraChavePixClient: KeymanagerRegistraChavePixGrpcServiceGrpc.KeymanagerRegistraChavePixGrpcServiceFutureStub) {
    ...
    fun create(clienteId: UUID, @Valid @Body request: NovaChavePixRequest): HttpResponse<Any> {
        ...
        return HttpResponse.created(location(clienteId, grpcResponse.get().pixId))
    }
